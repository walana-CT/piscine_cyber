 ...
 * SECTION:oath
 * @title: oath.h
 * @short_description: liboath declarations
 *
...
# define OATH_VERSION "2.6.11"
   ...
   */
# define OATH_VERSION_NUMBER 0x02060b00
 ...
 * @checksum: whether to add a checksum digit or not
 *
 ...
 *
 * Pre-processor compatibility definition for
 * oath_validate_strcmp_function().
 *
 * Since: 1.4.0
 */
